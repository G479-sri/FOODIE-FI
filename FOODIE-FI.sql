...
-- Engage the customers: Bring them to inside the company, show them the company value. We could measure it with sentiment analysis with data from social networks and determine a target percentage of positive sentiment regard our content.
